...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $explain = htmlspecialchars($_POST['explain'], ENT_QUOTES, 'UTF-8');
...
<body>
    ...
    <hr>
    <form action="shohin_insertTodb.php" method="post">
        <div>
            <label>商品名</label>
        ...
        <div>
            <label>商品説明</label>
            <p><?php echo nl2br($explain); ?></p>
            <input type="hidden" name="shohin_description" value="<?php echo $explain; ?>">
        </div>
